...
public partial class ChatView : UserControl
{
    public ChatView()
    {
        ...
        // Реплики появляются с коротким подъёмом, а не возникают рывком.
        // Без нарастающей задержки: ответ ждут сию секунду, и «доезжать» ему
        // тем дольше, чем длиннее разговор, было бы нелепо.
        ItemsStagger.AttachInstant(MessagesList);
    }
