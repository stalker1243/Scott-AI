...
class KnowledgeBase:
    ...
    def _migrate_old_memory(self) -> None:
        """
        Подхватить память из файла, оставшегося от ранних версий.

        Без переноса всё, что Scott выучил из разговоров, осталось бы в файле,
        к которому он больше не обращается.
        """
